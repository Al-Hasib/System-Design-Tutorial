...
Mermaid প্রকৃত circular/ring layout সমর্থন করে না, তাই ring order একটি labeled graph দিয়ে উপস্থাপন করা হয়েছে। প্রতিটি diagram-এ node order "ring order (clockwise)" মন্তব্য অনুসরণ করে — ring-টি প্রথম node-এ ফিরে wrap করার দৃশ্য কল্পনা করতে graph-টি সেই ক্রমে পড়ুন।

## 1. The Hash Ring: Nodes and Keys

Caption: Key-গুলো hash value অনুযায়ী ring-এ বসানো হয় এবং clockwise দিকে খুঁজে পাওয়া প্রথম node-এর মালিকানাধীন হয়।
...
Caption: প্রতিটি physical node একাধিকবার hash করা হয়, সমান load distribution-এর জন্য তার virtual point ring জুড়ে ছড়িয়ে দেওয়া হয়।
...
Caption: Node E যোগ করলে শুধুমাত্র Node C থেকে উত্তরাধিকারসূত্রে পাওয়া arc-ই remap হয়; বাকি সব node-এর key যথাস্থানে থাকে।
